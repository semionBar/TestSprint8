...
public class Mesto1Test {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2Njc3MDNmM2Q1NmMxNDAwM2Q0NzhmYzciLCJpYXQiOjE3MjQzNDQ5MzIsImV4cCI6MTcyNDk0OTczMn0.oEv9wfi51hv_Nx3q6XpCk5TKQFGws09yqHUTM9zFaVY";
    ...
    private void likePhotoById(String photoId) {
        ...
        given()
                ...
                .then().assertThat().statusCode(404); // Проверяем, что сервер вернул код 200
    }
